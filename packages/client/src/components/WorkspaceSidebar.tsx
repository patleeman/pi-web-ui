              ...
              <div className="py-1">
                <div className="flex w-full items-center">
                  <button
                    ...
                    className="group flex w-full flex-1 items-center gap-2 px-2 py-1 text-left transition-colors"
                  ...
                  >
                    ...
                    {collapsed ? (
                      ...
                      <span className="truncate font-medium text-pi-text">{workspace.name}</span>
                    )}
                  </button>
                  {!collapsed && (
                    <button
                      onClick={() => onCloseWorkspace(workspace.id)}
                      className="p-1 mr-1 text-pi-muted hover:text-pi-error transition-colors"
                  ...
                  <div className="mt-1 space-y-0.5">
                    {workspace.conversations.map((conversation) => (
                      <button
                        ...
                        className={`w-full flex items-center gap-1 px-2 py-1 text-[12px] transition-colors ${
